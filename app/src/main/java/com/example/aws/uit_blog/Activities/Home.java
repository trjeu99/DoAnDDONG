...
import com.example.aws.uit_blog.Fragments.HomeFragment;
import com.example.aws.uit_blog.Fragments.SettingsFragment;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            deleteKey = intent.getExtras().getString("postKey");
        }
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.container,new HomeFragment(deleteKey)).commit();
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent setup= new Intent(Home.this,ProfileActivity.class);
            startActivity(setup);
        ...
        {
            Intent searchIntent = new Intent(Home.this,HomeActivity.class);
